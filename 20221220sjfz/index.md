...
{{< admonition info 国家发展改革委负责同志深度解读数据二十条 false>}}
...
据基础制度建设事关国家发展和安全大局。《关于构建数据基础制度更好发挥数据要素作用的意见》（“数据二十条”）19日对外发布。意见出台的总体考虑是什么？怎样理解其内涵？记者就此采访了国家发展改革委负责同志。
...
六是加强工作整体统筹力度。发挥数字经济发展部际联席会议作用，促进跨地区跨部门跨层级协同联动，定期对数据基础制度建设情况进行评估，适时进行动态调整，推动数据基础制度体系不断丰富完善。（新华社记者潘洁）

{{< /admonition >}}

{{< admonition info 一图读懂数据二十条 false>}}
